      ...
      <main className="w-full flex flex-col gap-10 px-4 xl:px-0"> {/* Adjusted padding for mobile */}
        ...
        <nav>
          ...
          <ul className="space-y-1 text-base text-gray-600">
            ...
            <li><Link href="/projects/ga_data" className={`transition-colors duration-300 hover:text-blue-600 hover:font-black nav-link ${isActive("/projects/ga_data") ? "font-extrabold text-blue-600" : ""}`} onClick={handleLinkClick}>Log Analysis Visualizations</Link></li>
